...
//	}
	...
	public void TC_04() throws InterruptedException
	{
		...
		WebElement sony = driver.findElement(By.xpath("//a[text()='Sony Xperia']/parent::h2/following-sibling::div[@class='actions']//a[text()='Add to Compare']"));
		sony.click();
		Thread.sleep(2000);
		WebElement samsung = driver.findElement(By.xpath("//a[text()='Samsung Galaxy']/parent::h2/following-sibling::div[@class='actions']//a[text()='Add to Compare']"));
		samsung.click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//button[@title='Compare']")).click();
		//Step 06 - Switch qa cửa sổ mới
		String parentMobile = driver.getWindowHandle();
		switchToChildWindow(parentMobile);
		Thread.sleep(3000);
		//Step 07 - Verify title của cửa sổ bằng:  Products Comparison List - Magento Commerce
		Assert.assertEquals(driver.getTitle().trim(), "Products Comparison List - Magento Commerce");
		Thread.sleep(2000);
		closeAllWithoutParentWindows(parentMobile);
		Thread.sleep(2000);
